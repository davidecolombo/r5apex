...
- Edit `line 2` in [r5apex.ps1](r5apex.ps1) and change it to your preferred desktop resolution, for example: `Set-ScreenResolution -Width 1920 -Height 1080` this will set your screen resolution to 1920x1080 before the game is actually started
